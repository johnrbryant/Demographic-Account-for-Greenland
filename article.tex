...
\includegraphics[width=0.9\textwidth]{figures_accounts/fig_account_withage2.pdf}
...
Statistics Greenland has been disseminating statistical tables with Pxweb as multilingual internet based service since 2001. The technical core is [the Pxweb-family](https://www.scb.se/px-web), primarily developed by Statistics Sweden in cooperation with approximately 40 national statistical offices over a span of 5 decades. 
...
For the R-community the pxweb-package offers pxweb::interactive as a code-generator(learning ressource on how to consume pxweb statbanks). 
